...
class CategoryController extends Controller
{
    ...
    public function restore($id){
        ...
        if ($category->trashed()){
            ...
            return redirect()->route('categories.index')->with('status', "Category isn't in trash");
        }
    ...
    public function deletePermanent($id){
        ...
        if (!$category->trashed()) {
            ...
            return redirect()->route('categories.index')->with('status', 'Can not delete permanent an active category');
